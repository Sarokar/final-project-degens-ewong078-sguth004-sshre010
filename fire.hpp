...
public:
    ...
    void calcAttack(Combat& enemy) {
        if (enemy.getElement() == "Fire") {
            ...
            enemy.damage(temp);
            cout << getName() << " dealt " << temp << " fire damage to " << enemy.getName() << endl << "It was a normal attack." << endl << endl;
            ...
            enemy.damage(temp);
            cout << getName() << " dealt " << temp << " fire damage to " << enemy.getName() << endl << "DO YOU NOT UNDERSTAND SIMPLE TYPE ADVANTAGES? ARE YOU A 3HEAD??" << endl << endl;
            cout << "Armor: " << enemy.getArmor() << endl;
            cout << "Health: " << enemy.getHealth() << endl << endl;
        } 
            ...
            enemy.damage(temp);
            cout << getName() << " dealt " << temp << " fire damage to " << enemy.getName() << endl << "IT WAS SUPER EFFECTIVE!" << endl << endl;
            cout << "Armor: " << enemy.getArmor() << endl;
            cout << "Health: " << enemy.getHealth() << endl << endl;
        }
    ...
    void calcEnemyAttack(Combat& player) {
        ...
        if (player.getElement() == "Fire") {
            double temp = (attack + weaponStrength) * 1.0;
            player.damage(temp);
            cout << getName() << " dealt " << temp << " fire damage to " << player.getName() << endl << endl;
            ...
            double temp = (attack + weaponStrength) * 1.5;
            player.damage(temp);
            cout << getName() << " dealt " << temp << " fire damage to " << player.getName() << endl << "IT WAS SUPER EFFECTIVE!" << endl << endl;
            cout << "Armor: " << player.getArmor() << endl;
            cout << "Health: " << player.getHealth() << endl << endl;
        }
