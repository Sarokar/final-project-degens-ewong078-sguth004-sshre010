...
cin >> user;
longDelay();
//string _name, double _health, double _attack, double _weaponStrength, double _armor, string _element
//name, spd, hp, attack
Character grassPlayer(user, 0, 100, 20,"Grass");
Character waterPlayer(user, 0, 100, 20,"Water");
Character firePlayer3(user, 0, 100, 20,"Fire");
...
grassPlayer.newArmor(2);
grassPlayer.newWeapon(4);

firePlayer3.newArmor(2);
firePlayer3.newWeapon(4);
...
if(ans == "1") {
        ...
        //heal water
        waterPlayer.setHP(100);
        waterPlayer.newArmor(10);
        waterPlayer.newWeapon(10);


        firePlayer3.newArmor(45);
        firePlayer3.newWeapon(30);
        delay();
        ...
        cout << "Enemy first O_O" << endl;
        // ed.calcEnemyAttack(Player);
        ed.display(grassPlayer, 1);

        }
        if(grassPlayer.getHealth() == 0) {
                cout << "lol u lost in a text based game" << endl;
                return 0;
        }
        }
        ...
        grassPlayer.newArmor(10);
        grassPlayer.newWeapon(10);


        waterPlayer.newArmor(35);
        waterPlayer.newWeapon(35);
...
if(ans == "2") {
        ...
        firePlayer3.newArmor(10);
        firePlayer3.newWeapon(10);

        // Player.setArmor(30);
        // Player.setWeaponStrength(30);
        grassPlayer.newArmor(30);
        grassPlayer.newWeapon(30);
        ...
        if(ans == "1") {
        cout << "==============================================================" << endl;
        // grassPlayer.calcAttack(demon);
        grassPlayer.display(demon,0);
        ...
        if(ans == "1") {
        cout << "==============================================================" << endl;
        // waterPlayer.calcAttack(ed,0);
        waterPlayer.display(ed,0);
        delay();
        }
        else if(ans == "2") {
        string talking;
...
demonlord.display(firePlayer3, 1);
delay();
}
if(firePlayer3.getHealth() == 0) {
        cout << "lol u lost in a text based game" << endl;
